...
export interface EditMasterQuestionPayloadType {
	questionID:string
	jobPositionID: string
	updateQuestionList?: MasterQuestion[] | undefined
	updateBasicQuestionList?: BasicQuestionType[] | undefined
}
...
export interface UpdateBasicQuestionPayloadType {
	basicQuestionID?:string
	jobPositionID: string
	questionTh:string
	question:string
...
export interface UpdateMasterQuestionPayloadType {
	questionID:number
	jobPositionID: string
	questionThai:string
	questionEnglish:string
